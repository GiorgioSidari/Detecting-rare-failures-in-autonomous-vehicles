...
Run (needs MetaDrive):
    python scripts/plot_boundary_md.py --learned-model scenarios/lane_keeping_md/models/bc_state_mlp.joblib --speed-scale 0.3
    python scripts/plot_boundary_md.py --speed-scale 0.4        # robust pure-pursuit driver
"""
...
def main() -> None:
    ...
    drv = "learned BC" if args.learned_model else "pure-pursuit"
